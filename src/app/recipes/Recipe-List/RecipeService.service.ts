...
export class RecipeServiceService {
  ...
  recipes: Recipe[] = [
    new Recipe(
      ...
      [new Ingredient('minced meat',1),new Ingredient('cheese',10),new Ingredient('mornay sauce',2)]
    ),
    new Recipe(
      'Tomato Sauce',
      'a nice little tomato sauce',
      'https://www.cookingclassy.com/wp-content/uploads/2020/10/tomato-soup-7-600x900.jpg',
      [new Ingredient('tomato ',20),new Ingredient('water',10),new Ingredient('chreme fraise',1)]
    ),
  ];
